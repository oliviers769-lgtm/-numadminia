...
export default function Home({ onNavigate, large, toggleText, scale = 1, totalCompleted = 0, t, isRTL, lang, switchLang }) {
  const s = {
    wrap: {
      minHeight: '100vh',
    ...
    main: { maxWidth: 680, margin: '0 auto', padding: '2rem 1.5rem 6rem' },
    hero: {
    ...
    heroTitle: {
      ...
      fontSize: 32 * scale, fontWeight: 700, lineHeight: 1.2,
      color: '#fff', marginBottom: 12,
    },
    heroSub: {
      fontSize: 16 * scale, color: 'rgba(255,255,255,0.7)',
      lineHeight: 1.6, marginBottom: 28,
    },
    startBtn: {
      background: 'linear-gradient(135deg, #F59E0B, #FCD34D)',
      color: '#1E3A5F', fontSize: 15 * scale, fontWeight: 700,
    ...
    moduleCard: (i) => ({
      ...
      borderRadius: 18, padding: '1.2rem 1.5rem',
    ...
    moduleTitle: { fontWeight: 700, color: '#fff', fontSize: 15 * scale, marginBottom: 2 },
    moduleSub: { color: 'rgba(255,255,255,0.5)', fontSize: 12 * scale },
    statsRow: {
    ...
    statNum: { fontSize: 24 * scale, fontWeight: 700, color: '#F59E0B', display: 'block' },
    statLabel: { fontSize: 11 * scale, color: 'rgba(255,255,255,0.5)', marginTop: 2 },
  };
  ...
  return (
    <div style={s.wrap}>
      <AppHeader onNavigate={onNavigate} large={large} toggleText={toggleText} t={t} isRTL={isRTL} lang={lang} switchLang={switchLang} />
      <main style={s.main}>
        ...
        <div style={s.hero}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            ...
            <button style={{
              ...
              color: '#fff', fontSize: 15 * scale, fontWeight: 600,
          ...
          <div style={{
            ...
            borderRadius: 20, padding: '8px 16px', marginTop: 14,
            fontSize: 13 * scale, color: '#FCD34D', fontWeight: 600,
          }}>
            {heroBadge}
          </div>
        </div>
