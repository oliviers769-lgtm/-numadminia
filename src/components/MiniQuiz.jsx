...
const UI = {
  ...
  en: {
    title: 'Test your level in 2 questions',
    subtitle: 'Immediate result + recommended module',
    start: 'Start the test →',
    niveau: 'Level',
    bonnes: 'correct answers',
    recommande: 'Recommended module →',
    recommencer: 'Retake the test',
    question: 'Question',
    suivante: 'Next question →',
    resultat: 'See my result →',
  },
  it: {
    title: 'Metti alla prova il tuo livello in 2 domande',
    subtitle: 'Risultato immediato + modulo consigliato',
    start: 'Inizia il test →',
    niveau: 'Livello',
    bonnes: 'risposte corrette',
    recommande: 'Modulo consigliato →',
    recommencer: 'Rifare il test',
    question: 'Domanda',
    suivante: 'Domanda successiva →',
    resultat: 'Vedi il mio risultato →',
  },
  es: {
    title: 'Pon a prueba tu nivel en 2 preguntas',
    subtitle: 'Resultado inmediato + módulo recomendado',
    start: 'Empezar el test →',
    niveau: 'Nivel',
    bonnes: 'respuestas correctas',
    recommande: 'Módulo recomendado →',
    recommencer: 'Repetir el test',
    question: 'Pregunta',
    suivante: 'Siguiente pregunta →',
    resultat: 'Ver mi resultado →',
  },
  zh: {
    title: '用2个问题测试您的水平',
    subtitle: '即时结果 + 推荐模块',
